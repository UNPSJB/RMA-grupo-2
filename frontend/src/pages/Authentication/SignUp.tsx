...
const SignUp: React.FC = () => {
  ...
  return (
    <>
      <Breadcrumb pageName="Registrarse" />

      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
            <p style={{ fontSize: '30px', color: 'black' }}>RMA</p>
              <p className="2xl:px-20">
                Conozca nuestra red de monitoreo del caudal
                de la cuenca Sagmata del Río Chubut
              </p>
              <div className='flex items-center'>
                <img src={rmalogo} alt="Chubut" className="w-200 h-200"/>
             </div>
            </div>
          </div>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="Alerta mt-4 mb-4">
                  {alert.message && (
                    <Alerts
                      type={alert.type}
